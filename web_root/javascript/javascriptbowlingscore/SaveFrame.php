<?php
 ...
 $sql = "INSERT INTO frames (game_id, user_id,lane,frame_number,center_id,pattern_id,timestamp,b1_ball_id,b1_release,b1_gutter,
    ...
    VALUES ($gameid,$userid,$lane,$framecount,$centerid,$patternid,NOW(),NULL,$fingerreleaseid,0,0,$b1p1,$b1p2,$b1p3,$b1p4,$b1p5,$b1p6,$b1p7,$b1p8,$b1p9,$b1p10,NULL,$fingerreleaseid
